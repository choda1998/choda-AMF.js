(function() {
  ...
  AMFEncoder = (function(superClass) {
    ...
    function AMFEncoder(writable, options) {
      AMFEncoder.__super__.constructor.call(this, writable);
      if (options == null) {
        options = {};
      }
      this.options = {
        cacheStrings: options.cacheStrings !== false
      };
      this.amf0References = [];
  ...
  AMF3.INTEGER.encode = function(value) {
    ...
    return this.write([(value >> 22 & 0x7f) | 0x80, (value >> 15 & 0x7f) | 0x80, (value >> 8 & 0x7f) | 0x80, value & 0xff]);
  };
  ...
  AMF3.ARRAY.encode = function(value) {
    ...
    if (value instanceof Array) {
      AMF3.INTEGER.encode.call(this, value.length << 1 | 1);
      this.serialize("", AMF3);
      results = [];
      for (i = 0, len = value.length; i < len; i++) {
        element = value[i];
